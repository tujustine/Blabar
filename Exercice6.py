...
# Exercice 6 : afficher le nombre de ventes effectuées ce mois-ci par ses employé.e.s
        ...
        if bar_name in liste_bar:
            ...
            if id_and_bar in liste_g:
                ...
                if int(choice) == 1:
                    ...
                    print(f"Nombre total de boissons vendues et le CA associé pour {bar_name} :")
