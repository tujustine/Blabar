...
# Exercice 8 : afficher les boissons les moins vendues dans l’établissement ce mois-ci 
# et afficher les employé.e.s ayant vendu le moins de boissons.
            ...
            if id_and_bar in liste_g:
                ...
                if int(choice) == 1:
                    ...
                    curseur.execute("SELECT COUNT(V.Id_boisson) AS Ventes, C.Nom\
                                    ...
                                    JOIN CARTE AS C ON V.Id_boisson = C.Id_boisson\
                                    JOIN EMPLOYE AS EM ON V.Id_employe = EM.Matricule\
                                    JOIN ETABLISSEMENT ON ETABLISSEMENT.Nom=EM.Nom_Bar\
                                    AND EM.Nom_bar = ?\
